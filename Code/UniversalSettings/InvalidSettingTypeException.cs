...
namespace UniversalSettings
{
    ...
    /// </summary>
    public class InvalidSettingTypeException : SettingsException
    {
        ...
        public InvalidSettingTypeException( Type requestedType, Type actualType, Exception innerException ) 
